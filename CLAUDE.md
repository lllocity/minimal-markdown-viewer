...
- **Web 版（`web/`・Next.js 16）を開発中。** ステップ一覧は [docs/web/ROADMAP.md](./docs/web/ROADMAP.md) を参照（**W01〜W10 まで完了**・本番公開中 https://minimal-markdown-viewer-seven.vercel.app ）。当初ロードマップは全消化。別セッションで再開するときはまずこのロードマップを見ること。
